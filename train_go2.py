...
def progress(num_steps, metrics):
    ...
    fig.savefig("progress_plot_go2_Train114.png")  # Save the figure
...
with open("go2_params-Train114.pkl", "wb") as f:
    pickle.dump(params_numpy, f)

print("Params successfully saved as go2_params-Train114.pkl")
...
media.write_video("Go2_output-Train114.mp4", frames, fps=fps)
print(f"Media written to file Go2_output-Train114.mp4")